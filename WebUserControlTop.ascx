...
<div>
    <table width="1200px" style="border-width: 0px; padding-top: 10px; margin: 0 auto; border-bottom: solid 1px #dddddd;">
        <tr>
            <td style="width:200px;">
                <img src="images/cnlogo.png" style="height: 80px; margin-left:24px; float: left; cursor: pointer" onclick="window.open('Default.aspx', '_self');"
                    alt="" />
            </td>
            ...
            <td>
                <a href="Cart.aspx"><asp:Label ID="labCart" runat="server" CssClass="cart" Text="0"></asp:Label></a>
            </td>
        </tr>
    </table>
</div>
