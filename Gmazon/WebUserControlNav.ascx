<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlNav.ascx.cs"
    Inherits="Gmazon.WebUserControlNav" %>
<style type="text/css">
    *
    {
        margin: 0px;
...
<div id="navborder">
    <div id="nav">
        <div id="navhead">
            所有分类</div>
        <div id="navcontent">
            <asp:TreeView ID="TreeView1" runat="server" ExpandDepth="1" Width="200px" ShowExpandCollapse="False">
                ...
                <Nodes>
                    <asp:TreeNode Text="图书" Value="图书" SelectAction="None">
                        ...
                        <asp:TreeNode Text="艺术与摄影" Value="艺术与摄影" NavigateUrl="Category.aspx?class=ysysy">
                        </asp:TreeNode>
                        ...
                        <asp:TreeNode Text="哲学与宗教" Value="哲学与宗教" NavigateUrl="Category.aspx?class=zxyzj">
                        </asp:TreeNode>
                        ...
                        <asp:TreeNode Text="励志与成功" Value="励志与成功" NavigateUrl="Category.aspx?class=lzycg">
                        </asp:TreeNode>
                        ...
                        <asp:TreeNode Text="中小学教辅" Value="中小学教辅" NavigateUrl="Category.aspx?class=zxxjf">
                        </asp:TreeNode>
                        <asp:TreeNode Text="大中专教材" Value="大中专教材" NavigateUrl="Category.aspx?class=dzzjc">
                        </asp:TreeNode>
                        <asp:TreeNode Text="辞典与工具书" Value="辞典与工具书" NavigateUrl="Category.aspx?class=cdygjs">
                        </asp:TreeNode>
                        <asp:TreeNode Text="科技" Value="科技" NavigateUrl="Category.aspx?class=kj"></asp:TreeNode>
                        <asp:TreeNode Text="科学与自然" Value="科学与自然" NavigateUrl="Category.aspx?class=kxyzr">
                        </asp:TreeNode>
                        <asp:TreeNode Text="计算机与互联网" Value="计算机与互联网" NavigateUrl="Category.aspx?class=jsjyhlw">
                        </asp:TreeNode>
                    </asp:TreeNode>
                    <asp:TreeNode Text="作者" Value="作者" SelectAction="None">
                        <asp:TreeNode Text="郭敬明" Value="郭敬明" NavigateUrl="Category.aspx?author=郭敬明"></asp:TreeNode>
                        <asp:TreeNode Text="李玉刚" Value="李玉刚" NavigateUrl="Category.aspx?author=李玉刚"></asp:TreeNode>
                        <asp:TreeNode Text="东野圭吾" Value="东野圭吾" NavigateUrl="Category.aspx?author=东野圭吾"></asp:TreeNode>
                    </asp:TreeNode>
                </Nodes>
