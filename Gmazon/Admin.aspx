<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="Gmazon.Admin" %>
...
<body>
    ...
    <div>
        <table width="100%" style="border-width: 0px; margin: 0 auto; padding: 0px;">
            <tr align="center">
                <td align="center">
                    <asp:Button ID="Button1" runat="server" PostBackUrl="Default.aspx" Text="返回首页" CssClass="btn" />
                </td>
                <td align="center">
                    <asp:Button ID="Button2" runat="server" PostBackUrl="ModifyBook.aspx?mess=0" Text="添加新书"
                        CssClass="btn" />
                </td>
                <td align="center">
                    <asp:Button ID="Button3" runat="server" OnClick="Quit_Click" Text="退出登录" CssClass="btn" />
                </td>
            </tr>
        </table>
